...
(function() {
  ...
  Log = (function() {
    function Log() {
      ...
      default_config_path = '';
      if (_fs.existsSync("" + default_config + ".json")) {
        default_config_path = "" + default_config + ".json";
      }
      if (_fs.existsSync("" + default_config + ".js")) {
        default_config_path = "" + default_config + ".js";
      }
      if (_fs.statSync(default_config_path).isFile()) {
        _config = extend(_config, require(default_config_path));
      }
